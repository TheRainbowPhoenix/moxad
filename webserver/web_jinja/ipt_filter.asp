...
if (!debug) {
	...
	var malformated_data = {{ net_Web_MalFormated_WriteValue() | safe }};
...
var prot = [
	...
	{ value:'11', text:'FF Filedbus Message Specification (TCP)' },
	{ value:'12', text:'FF Filedbus Message Specification (UDP)' }, 
...
function fnInit(row) {
	...
	if(malformated_data.malLogEnable == 1)
		document.getElementById("malLogEnable").checked = true;
	else
		document.getElementById("malLogEnable").checked = false;

	var index;
    index = malformated_data.malLogLevel++; // +1, because the first value o
    myForm.malLogLevel.selectedIndex = index+1;
...
//	fnShowProp('aaaaa'+i, row);
	...
	var malLogEnable_temp = myForm.malLogEnable.checked;
	...
	myForm.malLogEnable.checked = malLogEnable_temp; 
...
*/	
	...
	cell = document.createElement("td");
	cell.innerHTML = fnGetSelText(wdata[i].logLevel, filter_level );
	row.appendChild(cell);

	cell = document.createElement("td");
	if(wdata[i].logFlash==1)
		cell.innerHTML = "<IMG src=" + 'images/enable_3.gif'+ ">";
	else
		cell.innerHTML = "<IMG src=" + 'images/disable_3.gif'+ ">";
	row.appendChild(cell);
...
{	
	...
	if(form.malLogEnable.checked == true )
		form.iptTemp.value = form.iptTemp.value + "1" + "+";
	else
		form.iptTemp.value = form.iptTemp.value + "0" + "+";

	form.iptTemp.value = form.iptTemp.value + (myForm.malLogLevel.selectedIndex-1) + "+";	// -1, because the first value of the options is -1 '--' 
...
<form name="qwe" id="myForm" method="POST" onSubmit="return stopSubmit()">
	...
	<DIV >
		<table cellpadding="1" cellspacing="3" style="width:300px;">
			<tr class=r0>
				 <td colspan=2><script language="JavaScript">doc(IPT_FILTER_GLOBAL_SETTING)</script></td>
			</tr>	
		</table>
		<table cellpadding="1" cellspacing="3" style="width:300px;">
			<tr class="r2">
				<td style="width:100px;" align="left">
					<script language="JavaScript">doc(IPT_FILTER_MALFORMED)</script><br/>
				</td>
				<td style="width:50px;" align="left" valign="center">
					<input type="checkbox" id="malLogEnable" name="malLogEnable">
				</td>
			</tr>
		</table>
		<table cellpadding="1" cellspacing="3" style="width:300px;">
			<tr>
				...
				<td style="width:120x;" align="left" valign="center">
					<script language="JavaScript">iGenSel2('ipt_malformed_logLevel', 'malLogLevel', malformed_level)</script>
				</td>
				<td style="width:100px;">
		...
		<table cellpadding="1" cellspacing="3" style="width:1200px;">
			<tr>
							...
							<td>
								<table>
									<tr>
										...
										<td style="width:120x;" align="left" valign="center">
											<script language="JavaScript">iGenSel2('ipt_filter_logLevel', 'logLevel', filter_level)</script>
										</td>
										<td style="width:100px;">
											<script language="JavaScript">doc(MOXA_FLASH_)</script><br/>
										</td>
									...
									<tr>
										...
										<td style="width:150px;" align="left">
											<select size=1 name="tSel" id="tSel" onchange="funcSel(this.selectedIndex);" >
												<option value="ipfilter">IP Filter</option>
												<option value="macfilter">MAC Filter</option>
											</select>
										</td>
									</tr>
								</table>	
				...
				<td>
				<td style="width:600px;" align="left" valign="top">	
					<table cellpadding="1" cellspacing="3" style="width:600px;" id="tatget_table">
						<tr>
					...
					<table cellpadding="1" cellspacing="3" style="width:600px;" id="ip_config_table1">
						<tr>
							<td style="width:100px;" align="left" valign="center">
								...
								<table>
									<tr>
										...
										<td id="src_ip_single_config" align="left" valign="center" style="display:none">  				
								  			...
								  			<input type="text" id=ip1 name="ipt_filter_ip_start" size=15 maxlength=15>
									   	</td>
									   	<td id="src_ip_range_config" align="left" valign="center" style="display:none">  				
								  			<input type="text" id=ip2 name="ipt_filter_ip_start1" size=15 maxlength=15>
								  			~
									       	<input type="text" id=ip3 name="ipt_filter_ip_end1" size=15 maxlength=15> 
									   	</td>
									</tr>
								</table>
							</td>
					...
					<table cellpadding="1" cellspacing="3" style="width:600px;" id="port_config_table1">
						<tr>
								...
								<table>
									<tr>
								        ...
								        <td id="src_port_single_config" align="left" valign="center" style="display:none">       	  	
								            <input type="text" id=port1 name="ipt_filter_port_start" size=5 maxlength=5> 
								        </td>
								        <td id="src_port_range_config" align="left" valign="center"  style="display:none">     	  	
								            <input type="text" id=port2 name="ipt_filter_port_start1" size=5 maxlength=5> 
								            ~                
								            <input type="text" id=port3 name="ipt_filter_port_end1" size=5 maxlength=5>
								        </td>
									</tr>
								</table>
							</td>
					...
					<table cellpadding="1" cellspacing="3" style="width:600px;" id="ip_config_table2">
						<tr>
							<td style="width:100px;" align="left" valign="center">
								...
								<table>
									<tr>
										...
										<td id="dst_ip_single_config" align="left" valign="center" style="display:none">  				
								  			...
								  			<input type="text" id=ip4 name="dst_ipt_filter_ip_start" size=15 maxlength=15>
									   	</td>
									   	<td id="dst_ip_range_config" align="left" valign="center" style="display:none">  				
								  			
								  			<input type="text" id=ip5 name="dst_ipt_filter_ip_start1" size=15 maxlength=15>
								  			~
									       	<input type="text" id=ip6 name="dst_ipt_filter_ip_end1" size=15 maxlength=15> 
									   	</td>
									</tr>
								</table>
							</td>
					...
					<table cellpadding="1" cellspacing="3" style="width:600px;" id="port_config_table2">
						<tr>
								...
								<table>
									<tr>
								        ...
								        <td id="dst_port_single_config" align="left" valign="center" style="display:none">
								            ...
								            <input type="text" id=port4 name="dst_ipt_filter_port_start" size=5 maxlength=5> 
								        </td>
								        <td id="dst_port_range_config" align="left" valign="center" style="display:none">     	  	
								            <input type="text" id=port5 name="dst_ipt_filter_port_start1" size=5 maxlength=5> 
								            ~                
								            <input type="text" id=port6 name="dst_ipt_filter_port_end1" size=5 maxlength=5>
								        </td>
									</tr>
								</table>
							</td>
	...
	<table cellpadding=1 cellspacing=2>	
		...
		<tr align="center">
 			...
 			<th class="s0" width="45px"><script language="JavaScript">doc(IPT_FILTER_INDEX)</script></td>
  			<th class="s0" width="60px"><script language="JavaScript">doc(INPUT_IFS)</script></td>
			<th class="s0" width="80px"><script language="JavaScript">doc(OUTPUT_IFS)</script></td>
			...
			<th class="s0" width="8px"><script language="JavaScript">doc(Severity_)</script></td>
			<th class="s0" width="50px"><script language="JavaScript">doc(MOXA_FLASH_)</script></td>
			<th class="s0" width="50px"><script language="JavaScript">doc(SYSLOG_SERVER_)</script></td>
			<th class="s0" width="50px"><script language="JavaScript">doc(SNMP_TRAP_)</script></td>
		</tr>
	</table>
</DIV>

<DIV style="width:1195px; overflow-y:auto;">
