...
function Entry_Init(row) {
	if(row >= 0){
		...
		document.getElementById("cerpw").value=wdata[row]['cer_pw']; 
		document.getElementById("cerpw").disabled=true;
	}else{
		document.getElementById('cername').innerHTML = '';
		document.getElementById('cersubject').innerHTML = '';
		document.getElementById("cerpw").value=''; 
...
{	
	...
	if((isSymbol(form.cer_pw, Password_)))
	{
		return;
	}
	form.action="/goform/web_p12Upload";	
	form.submit();
...
{	
	...
	{	
		document.getElementById('myForm').certmp.value = document.getElementById('myForm').certmp.value + wdata[i]['cer_lb'] + "+" + wdata[i]['cer_name'] + "+"+ wdata[i]['cer_pw'] + "+";		
	}	
	document.getElementById('myForm').action="/goform/net_WebP12TABLEGetValue";	
...
<h1><script language="JavaScript">doc(Local_);doc(' ');doc(CER_);doc(' ');doc(Upload_)</script></h1>
...
<div align="left">
    <table width="100%" align="center" border="0">
         ...
         <tr class=r0>
 	        ...
 	        <td width="67%" name="cer_subject" id=cersubject class=r1></td>
         	<td width="0%"></td>
         	<td width="0%"></td>
         </tr>
	</table>
    ...
    <table width="100%" align="center" border="0"> 
    	 <tr class=r0>
    	    <td width="10%"><div align="left"><font size="2" face="Arial, Helvetica, sans-serif, Marlett">
            	<br></font></div></td>
            <td width="23%"><div align="left">
                <script language="JavaScript">doc(P12_UP_)</script>
                </div></td>
	        <!--td width="25%"><div align="left"><font size="2" face="Arial, Helvetica, sans-serif, Marlett">
        ...
        <tr class=r0>
     	    <td width="10%"><div align="left"><font size="2" face="Arial, Helvetica, sans-serif, Marlett">
             	<br></font></div></td>
             <td width="23%"><div align="left">
                 <script language="JavaScript">doc(Import_);doc(' ');doc(Password_)</script>
                 </div></td>
 	        <td width="25%"><div align="left"><font size="2" face="Arial, Helvetica, sans-serif, Marlett">
            	<input type="text" name="cer_pw" id="cerpw" size="20" maxlength="40">
            	<br></font></div></td>
         	<td width="17%"></td>
         	<td width="25%"></td>
         </tr>
...
<tr></tr>
 <tr>
  ...
  <th width=120px><script language="JavaScript">doc(Password_)</script></td>
