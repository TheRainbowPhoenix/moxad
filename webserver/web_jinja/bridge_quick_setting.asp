...
<title><script language="JavaScript">doc(BR_ROUTING_QUICK_SETTING_)</script></title>
...
if (debug) {
	var devimage = {
		dev:"image/EDR-810.gif",f_lan:"image/Fiber-BR.png",f_wan:"image/Fiber-WAN.png",c_lan:"image/Copper-BR.png",c_wan:"image/Copper-WAN.png"
			,c_lanR:"image/Copper-BR-right.png",c_wanR:"image/Copper-WAN-right.png"
...
{{ net_Web_show_value('SRV_BRG') | safe }}
...
{{ net_Web_show_value('SRV_DHCP') | safe }}	
var wdata = [ {{ net_Web_IPT_NAT_WriteValue() | safe }} ];
var port_desc=[{{ net_webPortDesc() | safe }}];
var SYSPORTS = {{ net_Web_Get_SYS_PORTS() | safe }};	
var NoWAN = {{ net_Web_GetNO_WAN_WriteValue() | safe }};
var NoMAC_PORT = {{ net_Web_GetNO_MAC_PORTS_WriteValue() | safe }};
...
function Send(form, val){
    ...
    if(button_disable == 0) {
		...
		form.action="/goform/net_WebBridgeRoutingQuickSetting_GetValue?SRV=SRV_VPLAN&SRV0=SRV_VLAN&SRV1=SRV_BRG&wan=1&vid=2&state=1";
     ...
     <td colspan=4>
      <table border="0" cellpadding="0" cellspacing="0">
       <tr align="center"> 	
  	    ...
  	    <td class=r8 id="p1" name="setmode" ><script language="JavaScript">doc(BRIDGE_IP_Configuration);</script></td>
       ...
       <td valign="top">
        <table border="0">
  	   	 ...
  	   	 <tr class=r1 valign="top">
  	   	  ...
  	   	  <td><input type="text" id=lan_ip name="lanip" size=15 maxlength=15 onChange=ChgLanIP() value="192.168.126.254" ></td>
  	   	 </tr> 
  	   	 <tr class=r1 valign="top">
