...
<title><script language="JavaScript">doc(IPT_QOS_DOWN_LEVEL2_CONFIGURATION_EDRG902)</script></title>

<link href="./txtstyle.css" rel=stylesheet type="text/css">
<script language="JavaScript" src=mdata.js></script>
<script language="JavaScript">
checkCookie();
var Mode2QosDown={{ net_Web_GetMode_WriteValue() | safe }};
...
if (!debug) {
	...
	var wdata = [ {{ net_Web_IPT_QoS_Down_WriteValue() | safe }} ]
}

//net_Web_IPT_QoS_Down_WriteValue()
...
{	
	...
	form.action="/goform/net_WebQoSDownGetValue";
	form.submit();
}
...
{	
	if(ProjectModel == MODEL_EDR_G903)
		document.write('<td width="60px">'+INPUT_IFS+'</td>');
}
