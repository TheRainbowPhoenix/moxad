...
<body>
	...
	<table style='width:700px;'>
		<tr>
			<th style='width:20%; font-size:13px;'>{{ gettext("Tx Total") | safe }}</th>
			<th style='width:20%; font-size:13px;'>{{ gettext("Tx Unicast") | safe }}</th>
			<th style='width:20%; font-size:13px;'>{{ gettext("Tx Multicast") | safe }}</th>
			<th style='width:20%; font-size:13px;'>{{ gettext("Tx Broadcast") | safe }}</th>
			<th style='width:20%; font-size:13px;'>{{ gettext("Tx Collision") | safe }}</th>
		</tr>
		<tr>
	...
	<table style='width:700px; margin-top:5px;'>
		<tr>
			<th style='width:20%; font-size:13px;'>{{ gettext("Rx Total") | safe }}</th>
			<th style='width:20%; font-size:13px;'>{{ gettext("Rx Unicast") | safe }}</th>
			<th style='width:20%; font-size:13px;'>{{ gettext("Rx Multicast") | safe }}</th>
			<th style='width:20%; font-size:13px;'>{{ gettext("Rx Broadcast") | safe }}</th>
			<th style='width:20%; font-size:13px;'>{{ gettext("Rx Pause") | safe }}</th>
		</tr>
		<tr>
	...
	<table style='width:700px; margin-top:5px;'>
		<tr>
			<th style="width:25%; font-size:13px;" colspan="2">{{ gettext("Tx") | safe }}</th>
			<th style="width:75%; font-size:13px;" colspan="6">{{ gettext("Rx") | safe }}</th>
		</tr>
		<tr>
			<th style='width:12.5%; font-size:13px;'>{{ gettext("Late") | safe }}</th>
			<th style='width:12.5%; font-size:13px;'>{{ gettext("Excessive") | safe }}</th>

			<th style='width:12.5%; font-size:13px;'>{{ gettext("CRC Error") | safe }}</th>
			<th style='width:12.5%; font-size:13px;'>{{ gettext("Discard") | safe }}</th>
			<th style='width:12.5%; font-size:13px;'>{{ gettext("Undersize") | safe }}</th>
			<th style='width:12.5%; font-size:13px;'>{{ gettext("Fragments") | safe }}</th>
			<th style='width:12.5%; font-size:13px;'>{{ gettext("Oversize") | safe }}</th>
			<th style='width:12.5%; font-size:13px;'>{{ gettext("Jabber") | safe }}</th>
