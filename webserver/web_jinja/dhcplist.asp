...
<title><script language="JavaScript">doc(DHCP_Leased_List)</script></title>
...
{% include "dhcp_list" ignore missing %}
...
<script language="JavaScript">help("DHCP Leased List", "")</script>
<script language="JavaScript">mainh()</script>

<table cellpadding=1 cellspacing=2 id = "showleasetable">
 <tr class=r5 align="center">
  <td width=25%><script language="JavaScript">doc(Name_)</script></td>
  <td width=25%><script language="JavaScript">doc(MAC_Address)</script></td>
  <td width=16%><script language="JavaScript">doc(IP_Address)</script></td>
 <!-- <td width=10%><script language="JavaScript">doc(Type_)</script></td>
  <td width=11%><script language="JavaScript">doc(Status_)</script></td> -->
  <td width=34%><script language="JavaScript">doc(Time_Left)</script></td></tr>
