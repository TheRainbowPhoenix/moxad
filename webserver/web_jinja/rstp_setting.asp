...
<script type="text/javascript">
	...
	if (debug) {
		...
		{{ net_Web_show_value('SRV_RSTP_PORT') | safe }}	
		{{ net_Web_show_value('SRV_RSTP_SETTING') | safe }}	
		{{ net_Web_show_value('SRV_TRUNK_SETTING') | safe }}
        {{ net_Web_show_value('SRV_PORT_SETTING') | safe }}
		var port_desc=[{{ net_webPortDesc() | safe }}];
		var port_status = [ {{ net_Web_Port_Status_WriteValue() | safe }} ];
		var root_bridge =  "{{ net_Web_Root_Bridge_WriteValue() | safe }} ";
