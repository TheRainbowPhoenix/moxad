...
<table width="100%">
	...
	<tr>
		<td>
			...
			var NetworkMode = {{ net_Web_GetMode_WriteValue() | safe }};
			var ProjectModel = {{ net_Web_GetModel_WriteValue() | safe }};
			var ModelVLAN = {{ net_Web_GetModel_VLAN_WriteValue() | safe }};
			var ModelDVMRP = {{ net_Web_GetModel_DVMRP_WriteValue() | safe }};
			var No_WAN = {{ net_Web_GetNO_WAN_WriteValue() | safe }};
			var NoMAC_PORT = {{ net_Web_GetNO_MAC_PORTS_WriteValue() | safe }};
			var SYS_PORTS = {{ net_Web_Get_SYS_PORTS() | safe }}	
			var SWITCH_ROUTER=((parseInt(SYS_PORTS) > parseInt(NoMAC_PORT))&& (No_WAN > 0));
			var ModelRADIUS = {{ net_Web_GetModel_RADIUS_WriteValue() | safe }};
			var ModeVPN = {{ net_Web_GetMode_VPN_WriteValue() | safe }};
			var ModeL2TP = {{ net_Web_GetMode_L2TP_WriteValue() | safe }};
            checkCookie();
