...
<script language="JavaScript">
	...
	if (!debug) {
		var dvmrp_mrt_info = [
			{ origin:'192.168.127.1', nexthop:'aaa', inbif:'3', expire:'240', hold:'23'}		
		];
		...
		{{ net_Web_show_dvmrp_neighbors_info() | safe }}
...
<h1><script language="JavaScript">doc(DVMRP_+" "+ Routing_+" "+LIST_);</script></h1>
...
<table cellpadding=1 cellspacing=2 id="show_table" style="width:630px">
 <tr class=r5 align="center" width=630px>
  ...
  <th width=100px class="s0"><script language="JavaScript">doc(DVMRP_NEIGHBOR_IP_)</script></th>
  ...
  <th width=100px class="s0"><script language="JavaScript">doc(HOLD_TIME_)</script></th> 
  </tr>
</table>
