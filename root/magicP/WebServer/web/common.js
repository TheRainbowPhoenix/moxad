...
/*
	table_set_diff_show:
		用於Table要SHOW出的entries與使用者輸入的entries不同
		利用type來做區別

	table_show:
		用於Table要SHOW出的entries與使用者輸入的entries相同
