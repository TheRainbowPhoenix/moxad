...
<title><script language="JavaScript">doc(IPT_QOS_UP_LEVEL2_CONFIGURATION)</script></title>

<link href="./txtstyle.css" rel=stylesheet type="text/css">
<script language="JavaScript" src=mdata.js></script>
<script language="JavaScript">
checkCookie();
var Mode2QosUp=<% net_Web_GetMode_WriteValue(); %>;
...
if (!debug) {
	...
	var wdata = [ <% net_Web_IPT_QoS_Up_WriteValue(); %> ]
}
	...
	<table cellpadding=1 cellspacing=2>	
		...
		<tr class="r5" align="center">
 			...
 			<td width="45px"><script language="JavaScript">doc(IPT_FILTER_INDEX)</script></td>
  			<td width="60px"><script language="JavaScript">doc(OUTPUT_IFS)</script></td>
			...
			<td ><script language="JavaScript">doc(Targets)</script></td>
		</tr>
	</table>
</DIV>
<br>
<DIV style="width:885px; height:171px; overflow-y:auto;">
