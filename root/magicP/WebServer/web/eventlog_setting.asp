...
if (!debug) {
	...
	<%net_Web_show_value('SRV_EVENTLOG_MGMT');%>	
}
...
<table style='width:100%;'>
	...
	<tr><td colspan="2"><h2><% GetEventLogManagement(1); %> Enable Log Capacity Warning at <% GetEventLogManagement(2); %> (%)</h2></td><td></td></tr>        
	<tr><td colspan="3">&nbsp;&nbsp;&nbsp;&nbsp;Warning By:
						&nbsp;&nbsp;<% GetEventLogManagement(3); %> SNMP Trap
						&nbsp;&nbsp;<% GetEventLogManagement(4); %> Email
	</td></tr>
