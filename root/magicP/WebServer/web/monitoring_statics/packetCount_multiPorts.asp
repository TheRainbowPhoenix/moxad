...
<body>
	...
	<table id='id_TotalTableHeader' style='width:680px; display:none;'>
		<tr>
        	<th style='font-size:13px; width:6%'><%gettext("Port");%></th>
        	<th style='font-size:13px; width:34%'><%gettext("Tx");%></th>
        	<th style='font-size:13px; width:13%'><%gettext("Tx Error");%></th>
        	<th style='font-size:13px; width:34%'><%gettext("Rx");%></th>
        	<th style='font-size:13px; width:13%'><%gettext("Rx Error");%></th>
        </tr>
	</table>
	...
	<table id='id_TxTableHeader' style='width:680px; display:none;'>
		<tr>
        	<th style='font-size:13px; width:6%'><%gettext("Port");%></th>
        	<th style='font-size:13px; width:23.2%'><%gettext("Total");%></th>
        	<th style='font-size:13px; width:23.2%'><%gettext("Unicast");%></th>
        	<th style='font-size:13px; width:18.8%'><%gettext("Multicast");%></th>
        	<th style='font-size:13px; width:18.8%'><%gettext("Broadcast");%></th>
        	<th style='font-size:13px; width:10%'><%gettext("Collision");%></th>
        </tr>
	</table>
	...
	<table id='id_RxTableHeader' style='width:680px; display:none;'>
		<tr>
        	...
        	<th style='font-size:13px; width:18.8%'><%gettext("Multicast");%></th>
        	<th style='font-size:13px; width:18.8%'><%gettext("Broadcast");%></th>
        	<th style='font-size:13px; width:10%'><%gettext("Pause");%></th>
        </tr>
	</table>
	...
	<table id='id_ErrorTableHeader' style='width:680px; display:none;'>
		<tr>
        	<th style='font-size:13px; width:6%'><%gettext("Port");%></th>
        	<th style='font-size:13px; width:11.75%'><%gettext("Late");%></th>
        	<th style='font-size:13px; width:11.75%'><%gettext("Excessive");%></th>
        	<th style='font-size:13px; width:11.75%'><%gettext("CRC Error");%></th>
        	<th style='font-size:13px; width:11.75%'><%gettext("Discard");%></th>
        	<th style='font-size:13px; width:11.75%'><%gettext("Undersize");%></th>
        	<th style='font-size:13px; width:11.75%'><%gettext("Fragments");%></th>
        	<th style='font-size:13px; width:11.75%'><%gettext("Oversize");%></th>
        	<th style='font-size:13px; width:11.75%'><%gettext("Jabber");%></th>
        </tr>
	</table>
